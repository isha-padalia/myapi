...
router.get('/home', serverFunctions.home);

router.post('/register', serverFunctions.register);

router.post('/signin12', serverFunctions.signin12);

router.post('/logoutUser', serverFunctions.logoutUser);
